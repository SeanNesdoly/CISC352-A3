 ...
 * Customized to handle the required file formats of the AlphaBeta Pruning algorithm.
 *
...
public class TextFile {
    ...
    private static final String IN = SOURCEDIR + "alphabeta.txt"; // input file name
    private static final String OUT = SOURCEDIR + "alphabeta_out.txt"; // output file name
